...
REM SentientResearchAgent Docker Start Script for Windows
            ...
            if defined s3_mount_dir_line (
                ...
                if defined s3_mount_dir (
                    ...
                    if exist "!s3_mount_dir!" (
                        ...
                        call :print_warning "Skipping S3 compose override"
                    )
                ) else (
...
call :print_info "Starting Docker services with command:"
call :print_info "docker compose !compose_files! up -d"
...
call :print_info "Opening browser to frontend..."
