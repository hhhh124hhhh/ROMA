...
REM SentientResearchAgent Docker Stop Script for Windows
...
call :print_info "Stopping Docker services with command:"
call :print_info "docker compose !compose_files! down"
...
call :print_success "Docker services stopped successfully!"
